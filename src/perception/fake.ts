...
class FakePerception implements FakePerceptionHandle {
  ...
  getCameraGuidance(): string | null {
    return this.controls.cameraCovered ? "I can't see the patient. Prop the phone so I can see his chest." : null;
  }
